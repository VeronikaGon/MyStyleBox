...
public abstract class AppDatabase extends RoomDatabase {
    ...
    static final Migration MIGRATION_2_3 = new Migration(2, 3) {
        ...
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            // Если структура таблиц не изменилась, этот метод можно оставить пустым.
            // Например, если добавлены только новые записи, то никаких изменений в схеме не требуется.
            Log.d("AppDatabase", "Миграция 2 -> 3 выполнена.");
        }
    };
    ...
    private static final Callback prepopulateCallback = new Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            if (INSTANCE == null) {
                Log.e("AppDatabase", "База данных не инициализирована!");
                return;
            }
            Executors.newSingleThreadExecutor().execute(() -> {
                try {
                    ...
                    long sportswearId = categoryDao.insert(new Category("Спорт"));
                    long beachwearId = categoryDao.insert(new Category("Пляж"));
                    long underwearId = categoryDao.insert(new Category("Нижнее белье"));
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + topId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + bottomId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + dressId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + shoesId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + accessoriesId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + costumesId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + overallsId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + bagsId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + outerwearId);
                    Log.d("AppDatabase", "Вставленная категория: Верх, ID: " + headwearId);
                    ...
                    subcategoryDao.insert(new Subcategory((int) topId, "Халат"));
                    subcategoryDao.insert(new Subcategory((int) topId, "Футболка домашняя"));
                    subcategoryDao.insert(new Subcategory((int) topId, "Пижама"));
                    ...
                    subcategoryDao.insert(new Subcategory((int) bottomId, "Шорты домашние"));
                    ...
                    subcategoryDao.insert(new Subcategory((int) shoesId, "Тапочки"));
                    ...
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Купальник"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Бикини"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Туника пляжная"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Рубашка пляжная"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Шорты пляжная"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Костюм купальный"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Платье пляжное"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Плавки"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Парео"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Майка пляжная"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Шорты для плавания"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Танкини"));
                    subcategoryDao.insert(new Subcategory((int) beachwearId, "Монокини"));

                    subcategoryDao.insert(new Subcategory((int) underwearId, "Носки"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Трусы"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Майка (нижнее белье)"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Трусы-боксеры"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Колготки"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Колготки капроновые"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Боди"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Носки спортивные"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Гольфы"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Трико"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Кальсоны"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Термо бельё"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Трусы-стринги"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Трусы-слипы"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Трусы транки"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Бралетт"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Камисоль"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Боди-водолазка"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Лосины"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Бюстгальтер"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Бюстгальтер спортивный"));
                    subcategoryDao.insert(new Subcategory((int) underwearId, "Cорочка"));
                } catch (Exception e) {
                    Log.e("AppDatabase", "Ошибка при предварительном заполнении: " + e.getMessage());
                    e.printStackTrace();
                }
            });
        }
